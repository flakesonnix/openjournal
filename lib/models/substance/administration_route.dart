...
enum AdministrationRoute {
  ...
  transdermal(
    displayText: 'Transdermal',
    description: 'Through skin',
  ...
  subcutaneous(
    displayText: 'Subcutaneous',
    description: 'Injected between skin and muscle',
    ...
    isInjectionMethod: true,
    color: AdaptiveColor.teal,
  ),
  intramuscular(
    displayText: 'Intramuscular',
    description: 'Injected into muscle tissue',
  ...
  const AdministrationRoute({
    ...
    required this.isInjectionMethod,
    required this.color,
  });
  ...
  final bool isInjectionMethod;
  final AdaptiveColor color;

  static const psychonautWikiArticleUrl = 'https://psychonautwiki.org/wiki/Route_of_administration';
  static const saferInjectionArticleUrl = 'https://psychonautwiki.org/wiki/Safer_injection_guide';
  static const saferPluggingArticleUrl = 'https://wiki.tripsit.me/wiki/Quick_Guide_to_Plugging';
}

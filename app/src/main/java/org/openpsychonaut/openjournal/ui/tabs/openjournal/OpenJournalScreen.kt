...
import org.openpsychonaut.openjournal.ui.tabs.openjournal.components.ExperienceRow
...
fun ExperiencesScreenPreview(
    @PreviewParameter(
        OpenJournalScreenPreviewProvider::class,
